...
},{"fbjs/lib/invariant":16,"fbjs/lib/warning":18,"./lib/ReactPropTypesSecret":39}],11:[function(require,module,exports) {
...
},{"object-assign":15,"fbjs/lib/invariant":16,"fbjs/lib/emptyObject":17,"fbjs/lib/warning":18,"fbjs/lib/emptyFunction":19,"prop-types/checkPropTypes":20}],7:[function(require,module,exports) {
'use strict';
...
},{"./cjs/react.development.js":11}],21:[function(require,module,exports) {
/**
 * Copyright (c) 2013-present, Facebook, Inc.
 *
 * This source code is licensed under the MIT license found in the
...
},{"./isNode":47}],24:[function(require,module,exports) {
'use strict';
...
},{"./isTextNode":42}],41:[function(require,module,exports) {
'use strict';
...
},{"./camelize":43}],12:[function(require,module,exports) {
/** @license React v16.4.1
...
},{"fbjs/lib/invariant":16,"react":7,"fbjs/lib/warning":18,"fbjs/lib/ExecutionEnvironment":21,"object-assign":15,"fbjs/lib/emptyFunction":19,"prop-types/checkPropTypes":20,"fbjs/lib/getActiveElement":22,"fbjs/lib/shallowEqual":23,"fbjs/lib/containsNode":24,"fbjs/lib/emptyObject":17,"fbjs/lib/hyphenateStyleName":25,"fbjs/lib/camelizeStyleName":26}],8:[function(require,module,exports) {
'use strict';
...
},{"./cjs/react-dom.development.js":12}],4:[function(require,module,exports) {
"use strict";
...
var App = /** @class */function (_super) {
    ...
    function App() {
        ...
        _this.handleInfoClick = function (url) {
            var _a;
            var infoShown = _this.state.infoShown;
            var isOpened = Boolean(infoShown[url]);
            var nextInfoShown = __assign({}, infoShown, (_a = {}, _a[url] = !isOpened, _a));
            _this.setState({ infoShown: nextInfoShown });
        };
        _this.shouldShowInfo = function (url) {
            return Boolean(_this.state.infoShown[url]);
        };
        return _this;
    }
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, fetch('https://itunes-podcasts.firebaseio.com/items.json').then(function (response) {
    ...
    App.prototype.render = function () {
        ...
        var items = this.state.items.map(function (item) {
            return react_1.default.createElement("li", { key: item.url }, react_1.default.createElement("a", { href: item.url, target: "_blank" }, item.title), react_1.default.createElement("span", null, " / "), react_1.default.createElement("span", null, item.duration), item.description && react_1.default.createElement(react_1.Fragment, null, react_1.default.createElement("span", null, " / "), ",", react_1.default.createElement("button", { onClick: function onClick() {
                    return _this.handleInfoClick(item.url);
                } }, "toggle info")), _this.shouldShowInfo(item.url) ? react_1.default.createElement("pre", null, item.description) : null);
        });
        return react_1.default.createElement(react_1.Fragment, null, react_1.default.createElement("h1", null, "Radio Record Latest Podcasts"), react_1.default.createElement("ul", null, items));
    };
    return App;
}(react_1.Component);
react_dom_1.render(react_1.default.createElement(App, null), document.getElementById('root'));
},{"react":7,"react-dom":8}],49:[function(require,module,exports) {
...
//# sourceMappingURL=/podcasts.a97e4460.map